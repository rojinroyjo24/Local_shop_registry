  ...
  return (
    ...
    <div className="gradient-mesh">
      <div className="mx-auto max-w-[1320px] px-8 py-8 space-y-8">
        ...
        {/* ── Statistics ── UI CHANGE: compact 110px cards */}
          ...
          {stats.map((stat) => {
            ...
            return (
              <CardElement
                key={stat.label}
                {...cardProps}
                className={`group bg-white rounded-2xl border border-slate-200 p-5 h-[110px] flex items-center gap-4 shadow-sm hover:shadow-md hover:-translate-y-0.5 hover:border-blue-200 transition-all duration-300 ${
                  stat.link ? 'cursor-pointer' : ''
                }`}
              >
                {/* UI CHANGE: smaller icon box 40x40 */}
                <div className={`w-10 h-10 rounded-xl ${stat.gradient} shadow-sm flex items-center justify-center text-white flex-shrink-0 group-hover:scale-105 transition-transform duration-300`}>
                  {stat.icon}
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-[24px] font-bold text-slate-900 leading-none" style={{ fontFamily: 'var(--font-display)' }}>
                      {stat.value}
                    </span>
        ...
        {/* ── Quick Actions ── UI CHANGE: 140px cards, compact */}
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 animate-slide-up" style={{ animationDelay: '0.1s' }}>
            <Link
              to="/register"
              id="quick-register"
              className="group flex flex-col justify-between bg-white rounded-2xl border border-slate-200 p-5 h-[140px] shadow-sm hover:-translate-y-0.5 hover:shadow-md hover:border-blue-200 transition-all duration-300 cursor-pointer"
            >
              <div className="flex items-center justify-between">
                <div className="w-10 h-10 rounded-xl gradient-primary flex items-center justify-center text-white shadow-sm group-hover:scale-105 transition-transform duration-300">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                  </svg>
                </div>
            ...
            <Link
              to="/search"
              id="quick-search"
              className="group flex flex-col justify-between bg-white rounded-2xl border border-slate-200 p-5 h-[140px] shadow-sm hover:-translate-y-0.5 hover:shadow-md hover:border-green-200 transition-all duration-300 cursor-pointer"
            >
              <div className="flex items-center justify-between">
                <div className="w-10 h-10 rounded-xl gradient-secondary flex items-center justify-center text-white shadow-sm group-hover:scale-105 transition-transform duration-300">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="animate-slide-up space-y-3" style={{ animationDelay: '0.2s' }}>
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-white rounded-2xl border border-slate-200 shadow-sm">
              ...
              <p className="text-[14px] text-slate-600 mb-4">{error}</p>
              <button
                onClick={refetch}
            ...
            <div className="text-center py-16 bg-white rounded-2xl border border-slate-200 shadow-sm">
              ...
              <p className="text-[14px] text-slate-500 mb-6 max-w-sm mx-auto leading-relaxed">
